...
Goodbye [WordPress](http://www.wordpress.org/) - it's been great working with you. Hello, [Jekyll](http://jekyllrb.com).

Jekyll is a static site generator: an open-source tool for building simple but powerful websites of pretty much any shape or size. From [the project's readme](https://github.com/jekyll/jekyll/blob/master/README.markdown):
